...
keeps = c('BURGLARY', 'VANDALISM', 'ASSAULT', 'SEX OFFENSES, FORCIBLE', 'ROBBERY', 'DRUG/NARCOTIC', 'PROSTITUTION', 
          'RECOVERED VEHICLE', 'DRIVING UNDER THE INFLUENCE')  #is a recovered vehicle an abandoned vehicle?  'RECOVERED VEHICLE', 
df = df[df$Category %in% keeps,]
...
write.csv(concentration_time_series, "../Concentration_Levels/concentration_levels_sf.csv")
