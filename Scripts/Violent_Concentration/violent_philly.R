...
violent_crime = c('Aggravated Assault Firearm', 'Aggravated Assault No Firearm', 'Homicide - Criminal',
                  'Homicide - Justifiable', 'Homicide - Gross Negligence', 'Other Assaults',
                  'Rape', 'Robbery Firearm', 'Robbery Firearm')
df = df[df$GeneralCrimeCategory %in% violent_crime,]
